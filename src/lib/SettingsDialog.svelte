  ...
  <div class="dialog settings-dialog">
    ...
    <section class="block" data-testid="limits-section">
      ...
      <div class="mcp-field">
        ...
        <span class="hook-desc" id="limit-lost-ttl-desc">hours a resumable session lost to a host reboot or tmux restart is kept (past the usual one-cycle grace) before it is hard-deleted (0 = no extra grace)</span>
      </div>
      <div class="mcp-field">
