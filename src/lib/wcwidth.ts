/**
 * Terminal display width of a Unicode code point — the classic `wcwidth(3)`
 * contract used by xterm, tmux and friends:
 *
 *   0  — combining marks, zero-width joiners/spaces, variation selectors,
 *        format controls, C0/C1 controls (the caller decides what to do with
 *        controls; the screen buffer drops them before asking us)
 *   1  — everything else
 *   2  — East Asian Wide (W) and Fullwidth (F), which includes CJK, Hangul
 *        syllables and every emoji with default Emoji_Presentation
 *
 * The tables are derived from Unicode 15.0.0:
 *   - EastAsianWidth.txt   (property values W and F)     → WIDE
 *   - UnicodeData.txt      (general categories Mn, Me, Cf) → ZERO
 *   - emoji-data.txt       (Emoji_Presentation=Yes is already W in EAW 15)
 *   https://www.unicode.org/Public/15.0.0/ucd/
 * plus the two conventions every terminal wcwidth shares with Markus Kuhn's
 * reference implementation: Hangul Jamo medial vowels / final consonants
...
/** Zero-width code points: Mn / Me / Cf plus Hangul Jamo V/T. */
export const ZERO: readonly number[] = [
  ...
  0x0829, 0x082d, 0x0859, 0x085b, 0x0890, 0x0891, 0x0898, 0x089f, 0x08ca, 0x08e1,
  0x08e3, 0x0902, 0x093a, 0x093a, 0x093c, 0x093c, 0x0941, 0x0948, 0x094d, 0x094d,
  0x0951, 0x0957, 0x0962, 0x0963, 0x0981, 0x0981, 0x09bc, 0x09bc, 0x09c1, 0x09c4,
  0x09cd, 0x09cd, 0x09e2, 0x09e3, 0x09fe, 0x09fe, 0x0a01, 0x0a02, 0x0a3c, 0x0a3c,
  0x0a41, 0x0a42, 0x0a47, 0x0a48, 0x0a4b, 0x0a4d, 0x0a51, 0x0a51, 0x0a70, 0x0a71,
  0x0a75, 0x0a75, 0x0a81, 0x0a82, 0x0abc, 0x0abc, 0x0ac1, 0x0ac5, 0x0ac7, 0x0ac8,
  0x0acd, 0x0acd, 0x0ae2, 0x0ae3, 0x0afa, 0x0aff, 0x0b01, 0x0b01, 0x0b3c, 0x0b3c,
  0x0b3f, 0x0b3f, 0x0b41, 0x0b44, 0x0b4d, 0x0b4d, 0x0b55, 0x0b56, 0x0b62, 0x0b63,
  0x0b82, 0x0b82, 0x0bc0, 0x0bc0, 0x0bcd, 0x0bcd, 0x0c00, 0x0c00, 0x0c04, 0x0c04,
  0x0c3c, 0x0c3c, 0x0c3e, 0x0c40, 0x0c46, 0x0c48, 0x0c4a, 0x0c4d, 0x0c55, 0x0c56,
  0x0c62, 0x0c63, 0x0c81, 0x0c81, 0x0cbc, 0x0cbc, 0x0cbf, 0x0cbf, 0x0cc6, 0x0cc6,
  0x0ccc, 0x0ccd, 0x0ce2, 0x0ce3, 0x0d00, 0x0d01, 0x0d3b, 0x0d3c, 0x0d41, 0x0d44,
  0x0d4d, 0x0d4d, 0x0d62, 0x0d63, 0x0d81, 0x0d81, 0x0dca, 0x0dca, 0x0dd2, 0x0dd4,
  ...
  0x0f39, 0x0f39, 0x0f71, 0x0f7e, 0x0f80, 0x0f84, 0x0f86, 0x0f87, 0x0f8d, 0x0f97,
  0x0f99, 0x0fbc, 0x0fc6, 0x0fc6, 0x102d, 0x1030, 0x1032, 0x1037, 0x1039, 0x103a,
  0x103d, 0x103e, 0x1058, 0x1059, 0x105e, 0x1060, 0x1071, 0x1074, 0x1082, 0x1082,
  0x1085, 0x1086, 0x108d, 0x108d, 0x109d, 0x109d, 0x1160, 0x11ff, 0x135d, 0x135f,
  0x1712, 0x1714, 0x1732, 0x1733, 0x1752, 0x1753, 0x1772, 0x1773, 0x17b4, 0x17b5,
  0x17b7, 0x17bd, 0x17c6, 0x17c6, 0x17c9, 0x17d3, 0x17dd, 0x17dd, 0x180b, 0x180f,
  0x1885, 0x1886, 0x18a9, 0x18a9, 0x1920, 0x1922, 0x1927, 0x1928, 0x1932, 0x1932,
  0x1939, 0x193b, 0x1a17, 0x1a18, 0x1a1b, 0x1a1b, 0x1a56, 0x1a56, 0x1a58, 0x1a5e,
  0x1a60, 0x1a60, 0x1a62, 0x1a62, 0x1a65, 0x1a6c, 0x1a73, 0x1a7c, 0x1a7f, 0x1a7f,
  0x1ab0, 0x1ace, 0x1b00, 0x1b03, 0x1b34, 0x1b34, 0x1b36, 0x1b3a, 0x1b3c, 0x1b3c,
  0x1b42, 0x1b42, 0x1b6b, 0x1b73, 0x1b80, 0x1b81, 0x1ba2, 0x1ba5, 0x1ba8, 0x1ba9,
  0x1bab, 0x1bad, 0x1be6, 0x1be6, 0x1be8, 0x1be9, 0x1bed, 0x1bed, 0x1bef, 0x1bf1,
  0x1c2c, 0x1c33, 0x1c36, 0x1c37, 0x1cd0, 0x1cd2, 0x1cd4, 0x1ce0, 0x1ce2, 0x1ce8,
  0x1ced, 0x1ced, 0x1cf4, 0x1cf4, 0x1cf8, 0x1cf9, 0x1dc0, 0x1dff, 0x200b, 0x200f,
  0x2028, 0x202e, 0x2060, 0x2064, 0x2066, 0x206f, 0x20d0, 0x20f0, 0x2cef, 0x2cf1,
  ...
  0x10efd, 0x10eff, 0x10f46, 0x10f50, 0x10f82, 0x10f85, 0x11001, 0x11001, 0x11038, 0x11046,
  ...
  0x11f42, 0x11f42, 0x13430, 0x13440, 0x13447, 0x13455, 0x16af0, 0x16af4, 0x16b30, 0x16b36,
  0x16f4f, 0x16f4f, 0x16f8f, 0x16f92, 0x16fe4, 0x16fe4, 0x1bc9d, 0x1bc9e, 0x1bca0, 0x1bca3,
  0x1cf00, 0x1cf2d, 0x1cf30, 0x1cf46, 0x1d167, 0x1d169, 0x1d173, 0x1d182, 0x1d185, 0x1d18b,
...
/** Double-width code points: East Asian Wide (W) + Fullwidth (F). */
export const WIDE: readonly number[] = [
  ...
  0x31ef, 0x321e, 0x3220, 0x3247, 0x3250, 0x4dbf, 0x4e00, 0xa48c, 0xa490, 0xa4c6,
...
/** Binary search a flat, sorted `[lo, hi, …]` table for `cp`. */
function inTable(table: readonly number[], cp: number): boolean {
  let lo = 0;
  let hi = (table.length >> 1) - 1;
  if (cp < table[0] || cp > table[table.length - 1]) return false;
  while (lo <= hi) {
    const mid = (lo + hi) >> 1;
    const a = table[mid * 2];
    const b = table[mid * 2 + 1];
    if (cp < a) hi = mid - 1;
...
/** Display width (0, 1 or 2) of a single code point. */
export function wcwidth(cp: number): 0 | 1 | 2 {
  // Fast path: everything below U+0300 is either a control (width 0 — the
  // screen buffer never prints these) or a plain single-width glyph.
  if (cp < 0x0300) {
...
/** Display width of the first code point of a string (0 for empty). */
export function firstCharWidth(s: string): 0 | 1 | 2 {
  if (s.length === 0) return 0;
  return wcwidth(s.codePointAt(0)!);
}
