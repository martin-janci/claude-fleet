...
beforeEach(() => {
  ...
  hosts.set([
    ...
    { alias: 'hetzner', ssh_alias: 'hetzner', reachable: true, claude_version: null, tmux_version: null, hidden: false, last_pinged_at: 1, account_uuid: null, provisioned: false },
  ]);
