...
Of the 125 commands, 38 route to a hub tool, 1 routes except for one argument shape, 70 refuse, and 16 are the same in both modes; the full table is `src-tauri/src/backend/verdicts.rs`.
